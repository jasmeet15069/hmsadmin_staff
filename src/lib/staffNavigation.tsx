...
export const ROLE_PORTAL_PRESETS: Record<AppRole, RolePortalPreset> = {
  ...
  property_manager: {
    ...
    defaultPath: '/dashboard',
    modules: ['dashboard', 'rooms', 'guests', 'housekeeping', 'maintenance', 'complaints', 'payments', 'menu', 'inventory', 'order_queue', 'reports'],
  },
  receptionist: {
    role: 'receptionist',
    ...
    defaultPath: '/guests',
    modules: ['dashboard', 'rooms', 'guests', 'complaints', 'payments'],
  },
  admin: {
    role: 'admin',
  ...
  food_manager: {
    ...
    defaultPath: '/menu',
    modules: ['dashboard', 'menu', 'inventory', 'complaints'],
  },
  kitchen_manager: {
    ...
    defaultPath: '/kitchen',
    modules: ['dashboard', 'order_queue', 'inventory'],
  },
  waiter: {
    role: 'waiter',
