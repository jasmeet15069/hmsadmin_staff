...
export const STAFF_NAV_ITEMS: StaffNavItem[] = [
  { id: 'dashboard', label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: ['platform_admin', 'hotel_admin', 'property_manager', 'receptionist', 'super_admin', 'admin'] },
  ...
  { id: 'complaints', label: 'Complaints', href: '/complaints', icon: MessageSquareWarning, roles: ['platform_admin', 'hotel_admin', 'receptionist', 'super_admin', 'admin'] },
...
export const ROLE_PORTAL_PRESETS: Record<AppRole, RolePortalPreset> = {
  ...
  property_manager: {
    ...
    defaultPath: '/dashboard',
    modules: ['dashboard', 'staff', 'rooms', 'guests', 'housekeeping', 'maintenance', 'reports'],
  },
  receptionist: {
    role: 'receptionist',
  ...
  kitchen_manager: {
    ...
    defaultPath: '/kitchen',
    modules: ['staff', 'order_queue', 'inventory'],
  },
  waiter: {
    role: 'waiter',
